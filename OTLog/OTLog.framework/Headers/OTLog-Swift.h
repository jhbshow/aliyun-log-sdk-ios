...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTLog",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// 数据库管理器.支持增,删,查操作
SWIFT_CLASS("_TtC5OTLog9DBManager")
...
SWIFT_CLASS("_TtC5OTLog9LOGClient")
...
SWIFT_CLASS("_TtC5OTLog8LogGroup")
...
SWIFT_CLASS("_TtC5OTLog11OTLogConfig")
@interface OTLogConfig : NSObject
- (nonnull instancetype)initWithEndPoint:(NSString * _Nonnull)endPoint accessKeyID:(NSString * _Nonnull)accessKeyID accessKeySecret:(NSString * _Nonnull)accessKeySecret projectName:(NSString * _Nonnull)projectName logStoreName:(NSString * _Nonnull)logStoreName token:(NSString * _Nullable)token OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC5OTLog15OTLogGroupModel")
...
/// 单列
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OTLogManager * _Nonnull sharedInstance;)
+ (OTLogManager * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// 初始化
...
SWIFT_CLASS("_TtC5OTLog9SLSConfig")
